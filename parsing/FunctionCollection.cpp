...
void sanema::FunctionCollection::add_function( sanema::DefineFunction &function) {
    if(functions_per_name_and_type.count(function.identifier)==0) {
...
std::optional<sanema::DefineFunction> sanema::FunctionCollection::get_function_by_id(sanema::FunctionID id) {
